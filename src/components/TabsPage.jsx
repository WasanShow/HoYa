...
import {menuCompanyInfo,pathToKeyCompanyInfo,} from "./page-navigate/NavigateCompanyInfo";
import { menuMold, pathToKeyMold } from "./page-navigate/NavigateMold";
import { menuAutoStorage, pathToKeyAutostorage } from "./page-navigate/NavigateAutostorage";
import { menuDashboard, pathToKeyDashboard } from "./page-navigate/NavigateDashboard";
import { menuLocation, pathToKeyLocation } from "./page-navigate/NavigateLocation";
import { menuProductPlan, pathToKeyProductPlan } from "./page-navigate/NavigateProductPlan";
import { menuMobileShelf, pathToKeyMobileShelf } from "./page-navigate/NavigateMobileShelf";
import { menuMoldManage, pathToKeyMoldManage } from "./page-navigate/NavigateMoldManage";
import { menuRelocate, pathToKeyRelocate } from "./page-navigate/NavigateRelocate";
import { menuReport, pathToKeyReport } from "./page-navigate/NavigateReport";
